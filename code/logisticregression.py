...
# Step 2: create placehodlers for features and labels
# each image in MNIST data is of shape 28*28 = 784
...
entropy = tf.nn.softmax_cross_entropy_with_logits(
    logits=logits, labels=Y, name='loss')  # is a 1*10 tensor
loss = tf.reduce_mean(entropy)  # to make loss a number rather than a tensor
